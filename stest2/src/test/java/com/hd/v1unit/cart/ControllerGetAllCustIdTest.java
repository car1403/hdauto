...
@DisplayName(" Cart Controller Get ALl CustId Test ")
public class ControllerGetAllCustIdTest {
    @Autowired
    ...
    void success1() throws Exception {
        ...
        //stub
        given(cartService.getall(any())).willReturn(carts);

        //when
        ResultActions resultActions= mockMvc.perform(get("/api/cart/get/cust/"+custId));
    ...
    void success2() throws Exception {
        ...
        given(cartService.getall(any())).willThrow(
